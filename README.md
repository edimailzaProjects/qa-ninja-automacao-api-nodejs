# Sobre o Curso
Realizei este curso em 02/03/2020 e ele aborda conhecimentos de testes de API utilizado Docker, MongoDB, RabbitMQ e Jenkins;
A API se chama Treko-API e foi desenvolvido pela QA Ninja. Faz parte do pacote de cursos Automação Full Stack](http://qaninja.io/) da QA Ninja.
